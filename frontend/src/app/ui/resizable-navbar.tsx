    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                visible ? "text-white hover:text-white" : "text-black hover:text-black",
                className,
            )}
        >
            {items.map((item, idx) => (
                <a
                    ...
                    onClick={onItemClick}
                    className={cn(
                        "relative px-4 py-2 text-lg transition-all duration-200",
...
export const NavbarLogo = ({ visible }: { visible?: boolean }) => {
    return (
        <a
            href="#"
            className={cn(
                "relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal transition-colors duration-200",
                visible ? "text-white" : "text-black"
            )}
        >
            <img
...
export const NavbarButton = ({
    ...
    const variantStyles = {
        ...
        secondary: "bg-transparent shadow-none text-black dark:text-white border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800",
